...
OUTPUT_PATH="${JARVIS_IMPROVEMENT_QUANT_LEADERBOARD_OUTPUT_PATH:-}"
AS_OF_VALUE="${JARVIS_IMPROVEMENT_QUANT_LEADERBOARD_AS_OF:-}"
LOOKBACK_DAYS="${JARVIS_IMPROVEMENT_QUANT_LEADERBOARD_LOOKBACK_DAYS:-10}"
DOMAIN_VALUE="${JARVIS_IMPROVEMENT_QUANT_LEADERBOARD_DOMAIN:-quant_finance}"
SOURCE_VALUE="${JARVIS_IMPROVEMENT_QUANT_LEADERBOARD_SOURCE:-research_notes}"
MIN_CROSS_APP_COUNT="${JARVIS_IMPROVEMENT_QUANT_LEADERBOARD_MIN_CROSS_APP_COUNT:-1}"
STRICT_FLAG=""
EXTRA_ARGS=()
